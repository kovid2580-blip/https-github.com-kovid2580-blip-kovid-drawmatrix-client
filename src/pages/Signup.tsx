...
const Signup = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.data.user) {
                // Save token roughly - normally use context or secure cookie
            ...
            if (err.response && err.response.data.errors) {
                ...
                // Just show the first error found for simplicity
        ...
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 via-blue-600 to-cyan-400">
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-antigravity-muted mb-1">Username</label>
                        <input
                            type="text"
                            name="username"
                            required
                ...
                <div className="mt-6 text-center text-sm text-antigravity-muted">
                    Already have an account? <Link to="/login" className="text-antigravity-accent font-semibold hover:underline">Log in</Link>
                </div>
            </motion.div>
        </div>
    );
